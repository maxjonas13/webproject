...
@section('content')
	<div class="firstrow">
		...
		<p>
			...
			We had to create a project that was socially meaningfull. Out of this came BeeHive.<br> 
			BeeHive is created for people to help each other<br>
			Everybody has something he just can't do for himself, or just can't pay for.<br>
			That's where Beehive comes in. It can be a medium to meet people, make friends<br>
			and help each other to fix things for someone else.<br><br>
	...
	<div class="row"> 
		...
		<div class="column col-md-6 col-sm-6"> 
			...
			<p class="aboutus">
				Hi I'm Joren and I'm a student MT at the Karel de Grote College in Antwerp.<br>
				At a young age I started experimenting with websites and the language that goes with them. From then on I knew
